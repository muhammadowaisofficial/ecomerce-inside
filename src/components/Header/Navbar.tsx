  ...
  return (
    ...
    <NavigationMenu.Root className={`navbar flex items-center justify-between px-3 text-white h-20 border-b ${navColor ? "bg-[#00000070]" : "bg-transparent"}`} >
      ...
      <div className="logo h-full flex items-center">
        <Link href={'/'} className="">
          <Image alt="Ecommerce Inside" src={'/images/logo.png'}  width={300} height={70}/>
        </Link>
      </div>
      ...
      <div className="navbar flex items-center gap-8 sm:gap-2 md:gap-2">
        ...
        <Button variant="Green" className="sm:px-3" onClick={() => setModalActive(true)}>Request Info</Button>
        <MobileMenu />
      </div>
